...
image_dir = r"D:\Dev\repos\LBLQuiz\public\images"
...
for idx, img_path in enumerate(png_files, start=1):
    try:
        ...
        # These percentages remove the status bar, header, profile info, and navigation
...
print(f"Processing complete! Created {len(png_files)} cropped images.")
print(f"\nYou can now delete the original IMG_*.PNG files if you want.")
